...
$resultalbum = $album->getAllAlbums();
?>
<!DOCTYPE HTML>
<html>
    <head>
                            ...
                            <div class="row" >
                                <div class="col-md-8 col-sm-3" >
                                    ...
                                    <div class="row" style="margin-top: -25px;">
                                        <?php
                                        while ($rowA = mysqli_fetch_assoc($resultalbum)) {
                                            ?>
                                            <div class="col-md-4 " style="height: 270px;padding: 5px">
                                                <div class="hovereffect container row" style="height: 170px ;padding: 5px">
                                                    <div style="height: 170px">
                                                        <img id="img1" src="honest/Source Files/<?= $rowA['album_image'] ?>"  >
                                                    </div>
                                                    <div class="overlay" style="margin: 5px;margin-top: 10px;">
                                                        <div class="text" ><a href="albumImagess.php?album_id=<?=$rowA['album_id']?>" type="button" class="btn btn-default">පින්තුර  </a></div>
                                                ...
                                                <p style="padding-left: 9px;font-size: 13px;color: #000099;font-weight: bold;line-height: 1.3em;"><?= $rowA['album_title'] ?></p>
                                                <p style="margin-top: -18px;padding-left: 9px;font-size: 12px;line-height: 1.3em"><?= $rowA['album_comment'] ?></p>
                                            </div>
                                            <?php
                                        }
                                        ?>
