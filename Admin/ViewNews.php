                                            ...
                                            <tbody>
                                                <?php while ($row = mysqli_fetch_array($result)) { ?>
                                                    <tr>
                                                        ...
                                                        <td style="width: 50px">
                                                            <a href="../Admin/UpdateMember.php?member_id=<?php echo $row['news_id']; ?>"  style="color: white">  <button type="button" class="btn btn-warning btn-sm ">
                                                                    <i class="glyphicon glyphicon-edit"></i> </button>
                                                            </a>
                                                            <a href="UpdateUser.php?user_id=<?php echo $row['news_id']; ?>"  style="color: white">  <button type="button" class="btn btn-danger btn-sm ">
