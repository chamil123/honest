        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <form class="form-horizontal" action="Controller/AlbumController.php?action=add" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="dob">ඇල්බම්  පින්තූරය    :</label>
                                            <div class="col-sm-9">
                                                <span id="msgdob"></span>
                                                <input type="file" name="album_image" id="album_image" onchange="readURL(this);"/>

                                                <img id="blah" src="../uploads/default-placeholder-1024x1024-400x280.png" alt="your image" height="200px"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="lname">මාතෘකාව    :</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control required" id="album_title" name="album_title" placeholder="Enter album title">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="lname">විස්තරය     :</label>
                                            <div class="col-sm-6">
                                                <textarea type="text" class="form-control required" rows="6" id="alubum_comment" name="alubum_comment" placeholder="Enter album comments"></textarea>
                                                <!--<input type="text" class="form-control required" id="member_name" name="member_name" placeholder="Enter last name">-->
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="dob">ඇල්බමයට අදාල පින්තුර  :</label>
                                            <div class="col-sm-9">
                                                <span id="msgdob"></span>
                                                <input type="file" name="mutiple_images[]" multiple/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="submit" class="btn btn-success" value="ඇල්බමය ඇතුලත් කිරීම " name="AddUser"/>
