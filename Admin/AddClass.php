        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <form class="form-horizontal" action="Controller/ClassController.php?action=add" method="POST">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="lname">දූරය    :</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="submit" class="btn btn-success" value="Add Class" name="AddUser"/>
