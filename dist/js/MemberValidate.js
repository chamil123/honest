$(document).ready(function () {
    $("form").submit(function (event) {
        ...
        var member_center = $('#member_center').val();//to get the first name
        var member_br = $('#member_br').val();
        var centerNumber = $('#centerNumber').val();
        var member_no = $('#member_no').val();
        var member_nic = $('#member_nic').val();
        var member_surname = $('#member_surname').val();
        var member_initial = $('#member_initial').val();
        var member_fullInitial = $('#member_fullInitial').val();
        var member_dob = $('#member_dob').val();
        var member_status = $('#member_status').val();
        var member_nationality = $('#member_nationality').val();
...
//
        ...
        var patnTel = /^(\+\[94])+[0-9]{13}$/;
//var patnTel = '^\+[1-9]{1}[0-9]{3,14}$';
        //current date
        var today = new Date();
...
//
        ...
        if (isFormValid === false) {
            ...
            if (true) {
             ...
             if (!member_mobile.match(patnTel)) {
                event.preventDefault();
                ispaternok = false;
